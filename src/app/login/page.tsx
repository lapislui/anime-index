          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {providers.google ? (
                ...
                <button
                  disabled
                  title="Google SSO not configured in .env"
                  className="flex items-center justify-center gap-2 rounded-xl bg-slate-950/20 border border-border/20 px-4 py-2.5 text-xs font-bold text-muted/50 opacity-40 cursor-not-allowed"
                >
                  <svg className="h-4 w-4 opacity-50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#71717a"/>
                    <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#71717a"/>
                    <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22c-.87-2.6-2.87-4.53-6.19-4.53z" fill="#71717a"/>
                    <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z" fill="#71717a"/>
                  </svg>
                  Google
                </button>
              )}
              ...
              {providers.github ? (
                ...
                <button
                  disabled
                  title="GitHub SSO not configured in .env"
                  className="flex items-center justify-center gap-2 rounded-xl bg-slate-950/20 border border-border/20 px-4 py-2.5 text-xs font-bold text-muted/50 opacity-40 cursor-not-allowed"
                >
                  <svg className="h-4 w-4 fill-current opacity-50 text-muted" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/>
                  </svg>
                  GitHub
                </button>
              ...
              {providers.microsoft ? (
                ...
                <button
                  disabled
                  title="Microsoft SSO not configured in .env"
                  className="flex items-center justify-center gap-2 rounded-xl bg-slate-950/20 border border-border/20 px-4 py-2.5 text-xs font-bold text-muted/50 opacity-40 cursor-not-allowed"
                >
                  <svg className="h-4 w-4 opacity-50" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 0h11v11H0z" fill="#71717a"/>
                    <path d="M12 0h11v11H12z" fill="#71717a"/>
                    <path d="M0 12h11v11H0z" fill="#71717a"/>
                    <path d="M12 12h11v11H12z" fill="#71717a"/>
                  </svg>
                  Microsoft
                </button>
              )}
              ...
              {providers.discord ? (
                ...
                <button
                  disabled
                  title="Discord SSO not configured in .env"
                  className="flex items-center justify-center gap-2 rounded-xl bg-slate-950/20 border border-border/20 px-4 py-2.5 text-xs font-bold text-muted/50 opacity-40 cursor-not-allowed"
                >
                  <svg className="h-4 w-4 opacity-50 text-muted" viewBox="0 0 127.14 96.36" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#71717a" d="M107.7,8.07A105.15,105.15,0,0,0,77.26,0a77.19,77.19,0,0,0-3.3,6.83A96.67,96.67,0,0,0,52.22,6.83,77.19,77.19,0,0,0,48.92,0,105.15,105.15,0,0,0,18.48,8.07C-3.41,40.76-1,72.7,14.77,95.53A105.73,105.73,0,0,0,46,79.52a74.37,74.37,0,0,0,8.74-14.18A68.56,68.56,0,0,1,39,57.17c1.32-.95,2.61-2,3.83-3a75.14,75.14,0,0,0,81.42,0c1.22,1,2.51,2,3.83,3a68.56,68.56,0,0,1-15.77,8.17,74.37,74.37,0,0,0,8.74,14.18,105.73,105.73,0,0,0,31.27,16C128.25,72.7,130.66,40.76,107.7,8.07ZM42.45,65.69C36.18,65.69,31,60,31,53S36.18,40.36,42.45,40.36,53.88,46,53.88,53,48.72,65.69,42.45,65.69Zm42.24,0C78.41,65.69,73.24,60,73.24,53S78.41,40.36,84.69,40.36,96.12,46,96.12,53,91,65.69,84.69,65.69Z"/>
                  </svg>
                  Discord
                </button>
              )}
              ...
              {providers.facebook ? (
                <a
                  ...
                  className="flex items-center justify-center gap-2 rounded-xl bg-slate-950/60 border border-border/40 px-4 py-2.5 text-xs font-bold text-foreground hover:bg-slate-900/80 hover:border-accent/40 transition-all cursor-pointer col-span-2"
                >
                ...
                <button
                  disabled
                  title="Facebook SSO not configured in .env"
                  className="flex items-center justify-center gap-2 rounded-xl bg-slate-950/20 border border-border/20 px-4 py-2.5 text-xs font-bold text-muted/50 opacity-40 cursor-not-allowed col-span-2"
                >
                  <svg className="h-4 w-4 fill-current opacity-50 text-muted" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#71717a" d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                  Facebook
                </button>
              )}
